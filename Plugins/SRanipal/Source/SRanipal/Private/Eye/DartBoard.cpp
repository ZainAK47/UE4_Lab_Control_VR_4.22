...
void ADartBoard::Tick(float DeltaTime)
{
	...
	bool hit = USRanipal_FunctionLibrary_Eye::Focus(GazeIndex::COMBINE, RayLength, RayRadius, PlayerCameraRef, FocusInfo, GazeOrigin, GazeDirection);
...
void ADartBoard::MoveDartBoard() {
	bool EyeValid = USRanipal_FunctionLibrary_Eye::GetGazeRay(GazeIndex::COMBINE, GazeOrigin, GazeDirection);
