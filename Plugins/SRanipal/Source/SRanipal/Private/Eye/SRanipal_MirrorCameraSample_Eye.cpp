...
#include "SRanipal_MirrorCameraSample_Eye.h"
...
// Sets default values
ASRanipal_MirrorCameraSample_Eye::ASRanipal_MirrorCameraSample_Eye()
{
...
void ASRanipal_MirrorCameraSample_Eye::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ASRanipal_MirrorCameraSample_Eye::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

	FVector origin, direction;
	if (USRanipal_FunctionLibrary_Eye::GetGazeRay(GazeIndex::COMBINE, origin, direction) && !FirstFrame) {
