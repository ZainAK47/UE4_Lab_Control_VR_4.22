...
// Called every frame
void ADartBoard_v2::Tick(float DeltaTime)
{
	...
	bool hit = USRanipal_FunctionLibrary_Eye_v2::Focus(GazeIndex::COMBINE, RayLength, RayRadius, PlayerCameraRef, FocusInfo, GazeOrigin, GazeDirection);
...
float ADartBoard_v2::SignedAngle(FVector v1, FVector v2, FVector v_forward)
{
...
void ADartBoard_v2::MoveDartBoard() {
	bool EyeValid = USRanipal_FunctionLibrary_Eye_v2::GetGazeRay(GazeIndex::COMBINE, GazeOrigin, GazeDirection);
