...
#include "SRanipal_MirrorCameraSample_Eye_v2.generated.h"
...
*/
UCLASS()
class SRANIPAL_API ASRanipal_MirrorCameraSample_Eye_v2 : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ASRanipal_MirrorCameraSample_Eye_v2();
