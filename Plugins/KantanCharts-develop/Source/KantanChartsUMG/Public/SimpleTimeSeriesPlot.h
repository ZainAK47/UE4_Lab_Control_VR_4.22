...
public:
	...
	*/
	...
	void BP_AddDatapoint(FName SeriesId, FVector2D const& Point, bool& bSuccess, FColor Color = FColor::Green);
	...
	*/
	...
	void BP_AddDatapointNow(FName SeriesId, float Value, bool& bSuccess, FColor Color = FColor::Green);
