...
void USimpleTimeSeriesPlot::BP_AddDatapoint(FName SeriesId, FVector2D const& Point, bool& bSuccess, FColor Color)
{
	bSuccess = AddDatapoint(SeriesId, Point, Color);
}

void USimpleTimeSeriesPlot::BP_AddDatapointNow(FName SeriesId, float Value, bool& bSuccess, FColor Color)
{
