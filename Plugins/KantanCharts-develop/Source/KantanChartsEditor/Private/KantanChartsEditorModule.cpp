	...
	void CreatePreviewDatasources()
	{
		...
		if (ensure(PreviewCartesianPlotDatasource == nullptr))
		{
...

			{
				...
				PreviewCartesianPlotDatasource->AddDatapoint(Id, FVector2D(50.0f, 50.0f), FColor::Green);
				PreviewCartesianPlotDatasource->AddDatapoint(Id, FVector2D(100.0f, 0.0f), FColor::Green);
			}

			{
				auto Id = PreviewCartesianPlotDatasource->AddSeries(FText::FromString(TEXT("Series 2")));
				PreviewCartesianPlotDatasource->AddDatapoint(Id, FVector2D(0.0f, 0.0f), FColor::Green);
				PreviewCartesianPlotDatasource->AddDatapoint(Id, FVector2D(0.0f, -200.0f), FColor::Green);
				PreviewCartesianPlotDatasource->AddDatapoint(Id, FVector2D(-100.0f, -250.0f), FColor::Green);
			}
		...
		if (ensure(PreviewTimeSeriesPlotDatasource == nullptr))
		{
...

			{
				...
				PreviewTimeSeriesPlotDatasource->AddDatapoint(Id, FVector2D(50.0f, 50.0f), FColor::Green);
				PreviewTimeSeriesPlotDatasource->AddDatapoint(Id, FVector2D(100.0f, 0.0f), FColor::Green);
			}

			{
				auto Id = PreviewTimeSeriesPlotDatasource->AddSeries(FText::FromString(TEXT("Series 2")));
				PreviewTimeSeriesPlotDatasource->AddDatapoint(Id, FVector2D(0.0f, 0.0f), FColor::Green);
				PreviewTimeSeriesPlotDatasource->AddDatapoint(Id, FVector2D(20.0f, 10.0f), FColor::Green);
				PreviewTimeSeriesPlotDatasource->AddDatapoint(Id, FVector2D(40.0f, 40.0f), FColor::Green);
				PreviewTimeSeriesPlotDatasource->AddDatapoint(Id, FVector2D(60.0f, 100.0f), FColor::Green);
			}
